...
with open("inho_crash_req.json", "w", encoding="utf-8") as f: json.dump(payload, f)

res = subprocess.check_output(["aws", "ssm", "send-command", "--cli-input-json", "file://inho_crash_req.json", "--region", "us-east-1", "--output", "json"])
...
for _ in range(12):
    ...
    if out.returncode == 0:
        ...
        if data.get("Status") in ["Success", "Failed"]:
            with open("inho_crash_log.txt", "w", encoding="utf-8") as lf:
