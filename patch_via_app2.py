...
async def run():
    print("INSIDE APP PATCH SCRIPT AUTOCOMMIT")
    try:
...
commands = [
    f"cat << 'EOF' > /home/ubuntu/patch_via_app2.py\n{shell_code}\nEOF",
    "sudo docker cp /home/ubuntu/patch_via_app2.py inho_backend:/app/patch_via_app2.py",
    "sudo docker exec inho_backend python /app/patch_via_app2.py 2>&1"
]
