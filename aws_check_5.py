...
cmd = ["sudo docker ps -a > /tmp/report.txt", "echo --RESOURCES-- >> /tmp/report.txt", "free -m >> /tmp/report.txt", "cat /tmp/report.txt"]
...
with open('aws_docker_report.txt', 'w', encoding='utf-8') as f:
    f.write("--- OUTPUT ---\n")
