...
with open("down_up_req.json", "w") as f: json.dump(payload, f)

res = subprocess.check_output(["aws", "ssm", "send-command", "--cli-input-json", "file://down_up_req.json", "--region", "us-east-1", "--output", "json"])
