...
cmd = [
    "sudo find /home -name 'docker-compose.yml' -not -path '*/.*' -not -path '*/node_modules/*' 2>/dev/null",
    "sudo docker rm -f inho-backend-green",
...
with open('aws_docker_report3.txt', 'w', encoding='utf-8') as f:
