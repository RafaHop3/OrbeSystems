...
with open("ssm_fix_final.json", "w") as f: json.dump(payload, f)
res = subprocess.check_output(["aws", "ssm", "send-command", "--cli-input-json", "file://ssm_fix_final.json", "--region", "us-east-1", "--output", "json"], text=True)
