...
with open("fix_db_migration_req4.json", "w") as f:
    json.dump(payload, f)

res = subprocess.check_output(["aws", "ssm", "send-command", "--cli-input-json", "file://fix_db_migration_req4.json", "--region", "us-east-1", "--output", "json"])
