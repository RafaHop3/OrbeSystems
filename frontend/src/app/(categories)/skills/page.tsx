...
export default function SkillsPage() {
  ...
  return (
    <div className="space-y-10 font-mono">
      ...
      {showMeaning && (
        <ScrollReveal variant="fade-up" delay={0}>
          <section className="bg-neon-cyan/5 border border-neon-cyan/20 rounded p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {skillGroups.map((group, i) => (
          <ScrollReveal key={group.category} variant="fade-up" delay={i * 100}>
            <div className="space-y-4 bg-white/5 p-6 rounded border border-terminal-border/40 hover:border-neon-cyan/30 transition-all duration-300">
