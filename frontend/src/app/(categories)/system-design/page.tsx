            ...
            <div className="grid grid-cols-1 gap-2 mt-4 text-xs md:text-sm">
              {[
                ...
                <ScrollReveal key={item.name} variant="fade-left" delay={i * 60}>
                  <div
                    className="group flex items-center justify-between p-2 hover:bg-neon-blue/5 rounded transition-colors cursor-default border border-transparent hover:border-neon-blue/10"
                  >
                    <div className="flex items-center gap-4">
                      <span className="text-neon-blue/40">{item.type}</span>
                      <item.icon size={12} className="text-neon-blue/50 group-hover:text-neon-blue transition-colors" />
      ...
      <ScrollReveal variant="fade-in" delay={100}>
        <div className="pt-10 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 opacity-20">
            <Layers size={12} className="text-neon-blue" />
