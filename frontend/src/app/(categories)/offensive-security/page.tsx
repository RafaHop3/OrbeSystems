        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 gap-2 mt-4 text-xs md:text-sm">
            {[
              ...
              <div key={item.name} className="group flex items-center justify-between p-2 hover:bg-neon-purple/5 rounded transition-colors cursor-default border border-transparent hover:border-neon-purple/10">
