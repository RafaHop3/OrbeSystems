              ...
              <div className="flex flex-col gap-6 animate-fade-in">
                <div>
                  ...
                  <p className="text-xs text-terminal-muted mt-1 leading-relaxed">
                    Forneça uma descrição detalhada de seu ecossistema, infraestrutura, URL ou stack. A IA do IMORTAL avaliará a superfície de ataque, mapeará risks no OWASP Top 10 e gerará diretrizes imediatas de mitigação.
                  </p>
                </div>
