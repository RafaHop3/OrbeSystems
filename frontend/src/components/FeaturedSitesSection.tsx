...
const sites = [
    ...
    },
    {
        ...
        url: '/orbe-cleaner',
        image: '/featured-orbecleaner.png',
        accent: '#ff9900',
    ...
    {
        name: 'Orbe Workspace',
        tagline: 'Comando Central · Produtividade',
        url: '#',
        image: '/featured-workspace.png',
        accent: '#3b82f6',
    ...
    {
        name: 'Imortal (Logic Engine)',
        tagline: 'Formal Verification · Z3 Solver',
        url: '#',
        image: '/featured-imortal.png',
        accent: '#9333ea',
    ...
    {
        name: 'Imobverse',
        tagline: 'Proptech · Reputation Engine',
        url: '#',
        image: '/featured-imobverse.png',
        accent: '#6366f1',
    ...
    {
        name: 'PowerShell Bot',
        tagline: 'SecDevOps · SAST Auditor',
        url: '#',
        image: '/featured-powershellbot.png',
        accent: '#10b981',
