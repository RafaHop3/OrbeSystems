...
const securityHeaders = [
  ...
  // - Frame: none (matches X-Frame-Options: DENY)
  {
    ...
    value: [
      ...
      "connect-src 'self' data: http://localhost:8000 http://127.0.0.1:8000 http://52.20.22.241 https://api.orbesystems.com.br https://ipapi.co https://ipinfo.io https://*.vercel.app",
      "frame-src 'none'",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
