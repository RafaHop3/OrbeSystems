...
with open("chk_schema_req2.json", "w") as f:
    json.dump(payload, f)

res = subprocess.check_output(["aws", "ssm", "send-command", "--cli-input-json", "file://chk_schema_req2.json", "--region", "us-east-1", "--output", "json"])
...
for _ in range(15):
    ...
    if out.returncode == 0:
        ...
        if data.get("Status") in ["Success", "Failed"]:
            ...
            with open("d:\\OrbeSystems\\orbe-systems\\local_schema.txt", "w", encoding="utf-8") as f:
