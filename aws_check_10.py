...
cmd = [
    "cd /home/ubuntu/OrbeSystems && sudo docker compose up -d --build",
    "cd /home/ubuntu/orbe-repo && sudo docker compose up -d --build || true",
    "sudo docker ps > /tmp/report10.txt",
    "cat /tmp/report10.txt"
]
...
with open('aws_docker_report10.txt', 'w', encoding='utf-8') as f:
