...
with open("ssm_network.json", "w") as f: json.dump(payload, f)
res = subprocess.check_output(["aws", "ssm", "send-command", "--cli-input-json", "file://ssm_network.json", "--region", "us-east-1", "--output", "json"], text=True)
