...
commands = [
    "sudo docker logs inho_backend > /home/ubuntu/inho_crash.txt 2>&1",
    "tail -n 40 /home/ubuntu/inho_crash.txt"
]
...
while True:
    ...
    with open("inho_crash_out.txt", "w", encoding="utf-8") as f:
        f.write(out_text)
    print("SAVED TO inho_crash_out.txt")
    break
