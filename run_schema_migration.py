...
with open("fix_schema_migration_req.json", "w") as f:
    json.dump(payload, f)

res = subprocess.check_output(["aws", "ssm", "send-command", "--cli-input-json", "file://fix_schema_migration_req.json", "--region", "us-east-1", "--output", "json"])
