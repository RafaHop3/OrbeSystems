...
async def run():
    ...
    db_url = "postgresql+asyncpg://postgres:OrbeSystems123!@172.18.0.2:5432/orbesystemsprod"
...
commands = [
    f"cat << 'EOF' > /home/ubuntu/real_patch.py\n{shell_code}\nEOF",
    "sudo docker cp /home/ubuntu/real_patch.py inho_backend:/app/real_patch.py",
    "sudo docker exec inho_backend python /app/real_patch.py"
]
