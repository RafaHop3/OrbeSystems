...
with open("ssm_revert_port.json", "w") as f: json.dump(payload, f)
res = subprocess.check_output(["aws", "ssm", "send-command", "--cli-input-json", "file://ssm_revert_port.json", "--region", "us-east-1", "--output", "json"], text=True)
