...
with open("ssm_fix_port_80.json", "w") as f: json.dump(payload, f)
res = subprocess.check_output(["aws", "ssm", "send-command", "--cli-input-json", "file://ssm_fix_port_80.json", "--region", "us-east-1", "--output", "json"], text=True)
