...
commands = [
    f"cat << 'EOF' > /home/ubuntu/patch_pub.sql\n{sql}\nEOF",
    "sudo docker exec -e PGPASSWORD='OrbeSystems123!' orbe_postgres psql -h localhost -U postgres -d orbesystemsprod -a -f /home/ubuntu/patch_pub.sql 2>&1"
]
